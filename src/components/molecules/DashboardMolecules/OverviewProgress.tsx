...
function OverviewProgress({
  ...
  return (
    <div
      className={`flex flex-col-reverse md:flex-row items-center justify-center md:justify-between gap-4 max-w-80 w-full badge-ghost ${style} p-4 rounded-lg ring ring-offset-2 ring-offset-base-100 drop-shadow-lg`}
    >
